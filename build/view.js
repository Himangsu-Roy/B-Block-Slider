...
/***/ "./src/Components/BBlockSlider/BBlockSlider.js":
/*!*****************************************************!*\
  !*** ./src/Components/BBlockSlider/BBlockSlider.js ***!
  \*****************************************************/
...
const BBlockSlider = ({
  ...
  const isEditor = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select("core/edit-post") !== undefined, []);
  const {
    slides,
    titleTag,
    selectedIcon,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, slides && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    placeholder: "Enter slide description"
  }), isEditor ? slide.buttonLabel && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: "slide-button",
    tagName: "a",
    value: slide.buttonLabel,
    allowedFormats: ["core/bold", "core/italic"],
    onChange: value => {
      setAttributes({
        slides: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(slides, value, index, "buttonLabel")
      });
    },
    placeholder: "Enter button label"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BBlockSlider);
...
const Style = ({
  ...
  const slideStyles = slides.map((slide, index) => {
    const {
      backgroundConfig
    } = slide;
    return `
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      ...
      ${slideTitleSl}{
        font-family: ${titleTypography.fontFamily}, ${titleTypography.fontCategory};
      ...
      ${slideDescriptionSl}{
        font-family: ${descriptionTypography.fontFamily}, ${descriptionTypography.fontCategory};
      ...
      ${slideButtonSl}{
        font-family: ${buttonTypography.fontFamily}, ${buttonTypography.fontCategory};
      ...
      ${slideButtonSl}:hover{
        ...
        background-color: ${hoverColors?.bgType === "solid" ? hoverColors.bg : "transparent"};
...
/* harmony import */ var _Components_BBlockSlider_BBlockSlider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/BBlockSlider/BBlockSlider */ "./src/Components/BBlockSlider/BBlockSlider.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-b-blocks-b-block-slider");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_BBlockSlider_BBlockSlider__WEBPACK_IMPORTED_MODULE_5__["default"], {
      attributes: attributes,
      id: blockNameEl.id
    })));
